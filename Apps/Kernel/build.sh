...
ia16-elf-gcc -O2 -mcmodel=tiny -fno-jump-tables -nostartfiles \
    ...
    ./src/kernel.c ./src/malloc.c ./src/scheduler.c ./src/utils.c ./src/handleint.c \
    ../Lib/lowlevel.c ../Lib/strutils.c ../Lib/utils.c ../Lib/bios_screen.c ../Lib/bios_misc.c ../Lib/bios_fs.c ../Lib/crc8.c
rm crt0.o
